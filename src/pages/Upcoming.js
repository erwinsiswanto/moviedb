...
class Upcoming extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://api.themoviedb.org/3/movie/upcoming?api_key=108413e1a2cd7457bbf0b9df9953b7eb&language=en-US&page=1')
            .then(response => {
                this.setState({
                    images: images,
...
Upcoming.navigationOptions = ({navigation}) => ({
    header: (
        <Header navigate={navigation}>Upcoming Movies</Header>
    )
});
