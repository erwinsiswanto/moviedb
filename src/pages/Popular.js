...
class Popular extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://api.themoviedb.org/3/movie/popular?api_key=108413e1a2cd7457bbf0b9df9953b7eb&language=en-US&page=1')
            .then(response => {
                this.setState({
                    images: images,
...
Popular.navigationOptions = ({navigation}) => ({
    header: (
        <Header navigate={navigation}>Popular Movies</Header>
    )
});
